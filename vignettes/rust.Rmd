...
These constructors depend on the [rextendr](https://extendr.rs/rextendr/) R package. As a result, any limitation of rextendr is inherited by the constructors. Reading rextendr's own documentation is recommended.
